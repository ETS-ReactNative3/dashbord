      ...
      <div className="auth-page">
        ...
        >
          ...
          <form className="mt" onSubmit={this.doLogin}>
            ...
            <footer className={s.footer}>{new Date().getFullYear()} © Intercash - Admin Dashboard. &nbsp;<a href="https://intercash-africa.com" rel="noopener noreferrer" target="_blank">Site web</a></footer>
          </form>
        </Widget>
